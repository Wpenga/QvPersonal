...
{
    const NodeDataType NODE_TYPE_OUTBOUND{ "outbound", QObject::tr("Out") };
    const NodeDataType NODE_TYPE_INBOUND{ "inbound", QObject::tr("In") };
    const NodeDataType NODE_TYPE_RULE{ "rule", QObject::tr("Rule") };
    const NodeDataType NODE_TYPE_CHAINED_OUTBOUND{ "chain_outbound", QObject::tr("Chain") };
...
#define DECL_NODE_DATA_TYPE(name, TYPE, INNER_TYPE)                                                                                                                      \
    ...
    DECL_NODE_DATA_TYPE(InboundNodeData, NODE_TYPE_INBOUND, InboundObject);
    DECL_NODE_DATA_TYPE(OutboundNodeData, NODE_TYPE_OUTBOUND, OutboundObject);
    DECL_NODE_DATA_TYPE(RuleNodeData, NODE_TYPE_RULE, RuleObject);
    DECL_NODE_DATA_TYPE(ChainOutboundData, NODE_TYPE_CHAINED_OUTBOUND, OutboundObject);
...
#define DECL_NODE_DATA_MODEL(NAME, CONTENT_TYPE)                                                                                                                         \
    ...
    DECL_NODE_DATA_MODEL(InboundNodeModel, InboundObject);
    DECL_NODE_DATA_MODEL(OutboundNodeModel, OutboundObject);
    DECL_NODE_DATA_MODEL(RuleNodeModel, RuleObject);
    DECL_NODE_DATA_MODEL(ChainOutboundNodeModel, OutboundObject);
