...
SocksInboundEditor::SocksInboundEditor(QWidget *parent) : Qv2rayPlugin::Gui::QvPluginEditor(parent)
{
    setupUi(this);
...
void SocksInboundEditor::SetContent(const IOProtocolSettings &content)
{
